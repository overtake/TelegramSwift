...
public class SwitchView: Control {
    ...
    public required init(frame frameRect: NSRect) {
      ...
      //  layer?.isOpaque = true
        ...
        background.backgroundColor = TGColor.white.cgColor
        buble.backgroundColor = TGColor.white.cgColor
    ...
    func afterChanged() -> Void {
        if animates {
            ...
            background.backgroundColor = isOn ? TGColor.greenUI.cgColor : TGColor.white.cgColor
            background.borderWidth = isOn ? 0.0 : 1.0
            buble.borderWidth = isOn ? 0.0 : 1.0
            //  buble.backgroundColor = !isOn ? TGColor.border.cgColor : TGColor.white.cgColor
            
            //            buble.shadowColor = TGColor.blue.cgColor
    ...
    func resize() -> Void {
        ...
        background.borderColor = TGColor.border.cgColor
        
        buble.frame = bubleRect
        buble.cornerRadius = bubleRect.height/2.0
        buble.borderWidth = 1.0
        buble.borderColor = TGColor.border.cgColor
...
//        ctx.setFillColor(TGColor.grayBackground.cgColor)
