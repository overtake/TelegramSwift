...
public enum AutoNightSchedule : Equatable {
...
public struct AutoNightThemePreferences: Codable, Equatable {
    public let schedule: AutoNightSchedule?
    public let systemBased: Bool
    public let theme: DefaultTheme
    public static var defaultSettings: AutoNightThemePreferences {
    ...
    public init(schedule: AutoNightSchedule?, theme: DefaultTheme, systemBased: Bool) {
    ...
    public func withUpdatedSchedule(_ schedule: AutoNightSchedule?) -> AutoNightThemePreferences {
        return AutoNightThemePreferences(schedule: schedule, theme: self.theme, systemBased: self.systemBased)
    }
    
    public func withUpdatedTheme(_ theme: DefaultTheme) -> AutoNightThemePreferences {
        return AutoNightThemePreferences(schedule: self.schedule, theme: theme, systemBased: self.systemBased)
    }
    public func withUpdatedSystemBased(_ systemBased: Bool) -> AutoNightThemePreferences {
...
public func autoNightSettings(accountManager: AccountManager<TelegramAccountManagerTypes>) -> Signal<AutoNightThemePreferences, NoError> {
...
public func updateAutoNightSettingsInteractively(accountManager: AccountManager<TelegramAccountManagerTypes>, _ f: @escaping (AutoNightThemePreferences) -> AutoNightThemePreferences) -> Signal<Void, NoError> {
