...
NSImage * _Nullable renderPreparedImage(NSData * _Nonnull data, CGSize size, NSColor *backgroundColor, CGFloat scale) {
    NSDate *startTime = [NSDate date];
    ...
    bool isTransparent = [backgroundColor isEqual:[NSColor clearColor]];
