...
//            return AccentColorRowItem(initialSize, stableId: stableId, list: list, isNative: isNative, theme: theme, selectAccentColor: { color in
...
//        installed[tintedNightPalette.name] = tintedNightPalette
...
//        index += 1
//        
//        entries.append(.colorPalette(sectionId, index, settings.colors.name == tintedNightPalette.name && themeSettings.cloudTheme == nil, tintedNightPalette, nil))
//        index += 1
//        
//        
...
//
//        
//        entries.append(.colorPalette(sectionId, index, themeSettings.defaultDark.name == tintedNightPalette.parent, tintedNightPalette, nil))
//        index += 1
//        
//        
...
//                    .withUpdatedDefaultDark(DefaultTheme(name: .tintedNight, cloud: nil))
...
//                        return $0.withUpdatedCloudTheme(nil).withUpdatedToDefault(to: theme.colors.isDark)
//                    }).start()
//                }
