...
final class TelegramIconsTheme {
  ...
  var wallpaper_color_play: CGImage {
  ...
  var chat_voicechat_can_unmute: CGImage {
  ...
  var chat_voicechat_cant_unmute: CGImage {
  ...
  var chat_voicechat_unmuted: CGImage {
  ...
  var chat_info_change_colors: CGImage {
  ...
  var widget_peers_both_active: CGImage {
