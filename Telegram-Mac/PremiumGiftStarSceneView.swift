//
//  PremiumGiftStarSceneView.swift
//  Telegram
//
//  Created by Mike Renoir on 05.08.2022.
...
final class PremiumGiftStarSceneView: View, SCNSceneRendererDelegate {
...
//                let anglePan = deg2rad(Float(translation.x))
    ...
    private func setup() {
        guard let url = Bundle.main.url(forResource: "gift", withExtension: "scn"), let scene = try? SCNScene(url: url, options: nil) else {
            return
        }
