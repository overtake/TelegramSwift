                ...
                case .modern:
                    ...
                    if let title = (isRowSelected ? item.titleSelected : item.title) {
                        ...
                        if item.peer.isVerified && item.highlightVerified {
                            ...
                            ctx.draw(isRowSelected ? theme.icons.premium_account_rev_active : theme.icons.premium_account_rev, in: NSMakeRect(item.textInset + title.0.size.width + 5, tY, theme.icons.premium_account_rev.backingSize.width, theme.icons.premium_account_rev.backingSize.height))
                         }
