...
private func generateDiffuseTexture(colors: [NSColor]) -> CGImage {
...
final class GoldenStarSceneView: View, SCNSceneRendererDelegate, PremiumSceneView {
