...
private final class WallpaperPreviewView: View {
    ...
    private func addTableItems(_ context: AccountContext) {
        ...
        let firstEntry: ChatHistoryEntry = .MessageEntry(firstMessage, MessageIndex(firstMessage), true, .bubble, .Full(isAdmin: false), nil, nil, nil, AutoplayMediaPreferences.defaultSettings)
        ...
        let secondEntry: ChatHistoryEntry = .MessageEntry(secondMessage, MessageIndex(secondMessage), true, .bubble, .Full(isAdmin: false), nil, nil, nil, AutoplayMediaPreferences.defaultSettings)
