                ...
                if let detectedUrl = detectedUrl {
                    ...
                    if chatPresentationInterfaceState.chatLocation.peerId.namespace == Namespaces.Peer.SecretChat {
                        ...
                        if let value = value {
                            ...
                            if canLoad {
                               verifyModal(for: context.window, header: strings().chatSecretChatPreviewHeader, information: strings().chatSecretChatPreviewText, ok: strings().chatSecretChatPreviewOK, cancel: strings().chatSecretChatPreviewNO, successHandler: { result in
