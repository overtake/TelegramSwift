...
//        let node = StickerMediaContentView(frame: .zero)
//
//        node.update(with: file, size: NSMakeSize(70, 70), context: context, parent: nil, table: nil, parameters: nil, animated: false, positionFlags: nil, approximateSynchronousValue: false)
//        
