...
private func entries(_ state: State, arguments: Arguments) -> [InputDataEntry] {
    ...
    case let .upload(media, peer):
        ...
        let storyContentItem = StoryContentItem(position: nil, dayCounters: nil, peer: peer, storyItem: .init(id: 0, timestamp: 0, expirationTimestamp: 0, media: .init(media), alternativeMedia: nil, mediaAreas: [], text: "", entities: [], views: nil, privacy: nil, isPinned: false, isExpired: false, isPublic: false, isPending: false, isCloseFriends: false, isContacts: false, isSelectedContacts: false, isForwardingDisabled: false, isEdited: false, isMy: false, myReaction: nil, forwardInfo: nil, author: nil), entityFiles: [:], itemPeer: nil)
