...
struct AssociatedWallpaper : Codable, Equatable {
...
struct ThemeWallpaper : Codable, Equatable {
    let wallpaper: Wallpaper
...
struct DefaultCloudTheme : Equatable, Codable {
...
struct DefaultTheme : Equatable, Codable {
...
struct LocalWallapper : Equatable, Codable {
...
struct LocalAccentColor : Equatable, Codable {
    let name: TelegramBuiltinTheme
...
struct ThemePaletteSettings: Codable, Equatable {
    let palette: ColorPalette
    let bubbled: Bool
