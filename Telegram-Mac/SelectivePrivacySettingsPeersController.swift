...
//                let count = group.participantCount
//                var countValue = L10n.privacySettingsGroupMembersCountCountable(count)
...
//                if let count = peer.participantCount {
//                    let countValue = L10n.privacySettingsGroupMembersCountCountable(Int(count))
//                    status = countValue.replacingOccurrences(of: "\(count)", with: Int(count).separatedNumber)
//                } else {
//                    switch channel.info {
//                    case .group:
//                        status = L10n.peerStatusGroup
//                    case .broadcast:
//                        status = L10n.peerStatusChannel
//                    }
//                }
//            }
