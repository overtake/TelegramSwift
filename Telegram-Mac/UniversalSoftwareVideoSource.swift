...
private final class UniversalSoftwareVideoSourceImpl {
    ...
    func readImage(at timestamp: Double) -> (CGImage?, CGFloat, CGFloat, Bool) {
...
private final class UniversalSoftwareVideoSourceTakeFrameParams: NSObject {
    ...
    init(timestamp: Double, completion: @escaping (CGImage?) -> Void, cancel: Signal<Bool, NoError>, requiredDataIsNotLocallyAvailable: @escaping () -> Void) {
