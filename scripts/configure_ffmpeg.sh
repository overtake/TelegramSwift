...
BASE_PWD="${SCRIPT_DIR}/../submodules/ffmpeg"
FWNAME="ffmpeg"
OUTPUT_DIR=$( mktemp -d )

COMMON_SETUP=" -project ${SCRIPT_DIR}/../core-xprojects/ffmpeg/${FWNAME}.xcodeproj -configuration Release -quiet BUILD_LIBRARY_FOR_DISTRIBUTION=YES "
