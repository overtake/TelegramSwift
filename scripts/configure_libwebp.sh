...
BASE_PWD="${SCRIPT_DIR}/../submodules/libwebp"
FWNAME="libwebp"
OUTPUT_DIR=$( mktemp -d )

COMMON_SETUP=" -project ${SCRIPT_DIR}/../core-xprojects/libwebp/${FWNAME}.xcodeproj -configuration Release -quiet BUILD_LIBRARY_FOR_DISTRIBUTION=YES "
