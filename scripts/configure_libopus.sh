...
BASE_PWD="${SCRIPT_DIR}/../submodules/libopus"
FWNAME="libopus"
OUTPUT_DIR=$( mktemp -d )

COMMON_SETUP=" -project ${SCRIPT_DIR}/../core-xprojects/libopus/${FWNAME}.xcodeproj -configuration Release -quiet BUILD_LIBRARY_FOR_DISTRIBUTION=YES "
