...
BASE_PWD="${SCRIPT_DIR}/../submodules/OpenSSL"
FWNAME="OpenSSLEncryption"
OUTPUT_DIR=$( mktemp -d )

COMMON_SETUP=" -project ${SCRIPT_DIR}/../core-xprojects/OpenSSL/${FWNAME}.xcodeproj -configuration Release -quiet BUILD_LIBRARY_FOR_DISTRIBUTION=YES "
