...
BASE_PWD="${SCRIPT_DIR}/../submodules/webrtc"
FWNAME="webrtc"
OUTPUT_DIR=$( mktemp -d )

COMMON_SETUP=" -project ${SCRIPT_DIR}/../core-xprojects/webrtc/${FWNAME}.xcodeproj -configuration Release -quiet BUILD_LIBRARY_FOR_DISTRIBUTION=YES "
