...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=x86_64 --cc='xcrun -sdk macosx clang' --as='/Users/mikerenoir/projects/Telegram-macOS/Telegram/core-xprojects/ffmpeg/../../submodules/telegram-ios/submodules/ffmpeg/Sources/FFMpeg/gas-preprocessor.pl -- xcrun -sdk macosx clang' --enable-cross-compile --disable-programs --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-doc --enable-pic --disable-all --disable-everything --enable-avcodec --enable-swresample --enable-avformat --disable-xlib --enable-libopus --enable-libvpx --enable-audiotoolbox --enable-bsf=aac_adtstoasc --enable-decoder='h264,libvpx_vp9,hevc,libopus,mp3,aac,flac,alac,pcm_s16le,pcm_s24le,gsm_ms,aiff' --enable-demuxer='aac,mov,m4v,mp3,ogg,libopus,flac,wav,aiff,matroska' --enable-parser='aac,h264,mp3,libopus' --enable-protocol=file --enable-muxer=mp4 --disable-debug --extra-cflags='-arch x86_64 -mmacosx-version-min=10.11' --extra-ldflags='-arch x86_64 -mmacosx-version-min=10.11' --prefix=/Users/mikerenoir/projects/Telegram-macOS/Telegram/core-xprojects/ffmpeg/build/thin/x86_64 --pkg-config=/Users/mikerenoir/projects/Telegram-macOS/Telegram/core-xprojects/ffmpeg/../../submodules/telegram-ios/submodules/ffmpeg/Sources/FFMpeg/pkg-config --pkg-config-flags='--libopus_path /Users/mikerenoir/projects/Telegram-macOS/Telegram/core-xprojects/ffmpeg/build/../../libopus/build/libopus --libvpx_path /Users/mikerenoir/projects/Telegram-macOS/Telegram/core-xprojects/ffmpeg/build/../../libvpx/build/libvpx'
prefix=/Users/mikerenoir/projects/Telegram-macOS/Telegram/core-xprojects/ffmpeg/build/thin/x86_64
...
CXX=g++
AS=/Users/mikerenoir/projects/Telegram-macOS/Telegram/core-xprojects/ffmpeg/../../submodules/telegram-ios/submodules/ffmpeg/Sources/FFMpeg/gas-preprocessor.pl -- xcrun -sdk macosx clang
OBJCC=xcrun -sdk macosx clang
LD=xcrun -sdk macosx clang
DEPCC=xcrun -sdk macosx clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/Users/mikerenoir/projects/Telegram-macOS/Telegram/core-xprojects/ffmpeg/../../submodules/telegram-ios/submodules/ffmpeg/Sources/FFMpeg/gas-preprocessor.pl -- xcrun -sdk macosx clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=yasm
DEPX86ASM=yasm
...
CFLAGS=  -arch x86_64 -mmacosx-version-min=10.11 -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -pthread  -I/Users/mikerenoir/projects/Telegram-macOS/Telegram/core-xprojects/ffmpeg/build/../../libopus/build/libopus/include/opus -I/Users/mikerenoir/projects/Telegram-macOS/Telegram/core-xprojects/ffmpeg/build/../../libvpx/build/libvpx/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch x86_64 -mmacosx-version-min=10.11 -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch x86_64 -mmacosx-version-min=10.11  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
