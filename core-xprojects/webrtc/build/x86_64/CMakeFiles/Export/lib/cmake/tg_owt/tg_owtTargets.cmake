...
add_library(tg_owt::tg_owt_avx2 INTERFACE IMPORTED)

set_target_properties(tg_owt::tg_owt_avx2 PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_20"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/tg_owt"
  INTERFACE_LINK_LIBRARIES "tg_owt::libwebrtcbuild;\$<LINK_ONLY:tg_owt::libabsl>"
)

# Create imported target tg_owt::tg_owt_sse2
add_library(tg_owt::tg_owt_sse2 INTERFACE IMPORTED)

set_target_properties(tg_owt::tg_owt_sse2 PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_20"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/tg_owt"
  INTERFACE_LINK_LIBRARIES "tg_owt::libwebrtcbuild;\$<LINK_ONLY:tg_owt::libabsl>"
)
