...
public class TimableProgressView: View {
    ...
    public func startAnimation() {
        ...
        timer = SwiftSignalKit.Timer(timeout: 1 / fps, repeat: true, completion: { [weak self] in
    ...
    public override func draw(_ layer: CALayer, in ctx: CGContext) {
        ...
        let center = NSMakePoint(frame.width/2, frame.height/2)
        ...
        let radius: CGFloat = frame.width/2 - theme.outer
